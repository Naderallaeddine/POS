...
namespace POS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260419171656_StoreSettings")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "8f4a9ef9-0c89-43a5-9f3f-1c9a4a6df003",
                            ConcurrencyStamp = "8f4a9ef9-0c89-43a5-9f3f-1c9a4a6df003",
                            Name = "Manager",
            ...
            modelBuilder.Entity("POS.Domain.Entities.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d6a61e2e-b3dd-4b2b-9d9a-3b5e2c1c0001"),
                            Code = "MAIN",
            ...
            modelBuilder.Entity("POS.Domain.Entities.StoreSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a1c2b3d4-e5f6-4789-a012-3456789abcde"),
                            BranchId = new Guid("d6a61e2e-b3dd-4b2b-9d9a-3b5e2c1c0001"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            CurrencyCode = "USD",
                            CurrencySymbol = "$",
            ...
            modelBuilder.Entity("POS.Domain.Entities.StoreSettings", b =>
                {
                    b.HasOne("POS.Domain.Entities.Branch", "Branch")
                        ...
                        .HasForeignKey("POS.Domain.Entities.StoreSettings", "BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
